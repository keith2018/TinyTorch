...
#define INSTANTIATE_TOPK_OP(T) \
  template TensorPair topkOpCudaImpl<T>(const Tensor& self, int64_t k, int64_t dim, bool largest, bool sorted);
FOR_ALL_TYPES(INSTANTIATE_TOPK_OP)
#undef INSTANTIATE_TOPK_OP
...
#define INSTANTIATE_MULTINOMIAL_OP(T) \
  template Tensor multinomialOpCudaImpl<T>(const Tensor& self, int64_t nSamples, bool replacement);
FOR_ALL_TYPES(INSTANTIATE_MULTINOMIAL_OP)
#undef INSTANTIATE_MULTINOMIAL_OP
...
#define INSTANTIATE_SORT_OP(T) template TensorPair sortOpCudaImpl<T>(const Tensor& self, int64_t dim, bool descending);
FOR_ALL_TYPES(INSTANTIATE_SORT_OP)
#undef INSTANTIATE_SORT_OP
...
#define INSTANTIATE_CUMSUM_OP(T) template Tensor cumsumOpCudaImpl<T>(const Tensor& self, int64_t dim);
FOR_ALL_TYPES(INSTANTIATE_CUMSUM_OP)
#undef INSTANTIATE_CUMSUM_OP

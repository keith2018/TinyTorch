...
TEST(TEST_Optimizer, SGD) {
  ...
  optimizer.step();
  EXPECT_FLOAT_VEC_NEAR(x.data().toArray(), {0.4500, 1.4000, -0.4900});
  optimizer.step();
  EXPECT_FLOAT_VEC_NEAR(x.data().toArray(), {0.4062, 1.3124, -0.4812});
}
...
TEST(TEST_Optimizer, Adagrad) {
  ...
  optimizer.step();
  EXPECT_FLOAT_VEC_NEAR(x.data().toArray(), {0.4258, 1.4133, -0.5156});
  optimizer.step();
  EXPECT_FLOAT_VEC_NEAR(x.data().toArray(), {0.3967, 1.3805, -0.5225});
}
...
TEST(TEST_Optimizer, RMSprop) {
  ...
  optimizer.step();
  EXPECT_FLOAT_VEC_NEAR(x.data().toArray(), {0.1903, 1.7974, -0.8123});
  optimizer.step();
  EXPECT_FLOAT_VEC_NEAR(x.data().toArray(), {-0.2879, 2.1821, -1.3057});
}
...
TEST(TEST_Optimizer, AdaDelta) {
  ...
  optimizer.step();
  EXPECT_FLOAT_VEC_NEAR(x.data().toArray(), {0.4917, 1.5045, -0.5093});
  optimizer.step();
  EXPECT_FLOAT_VEC_NEAR(x.data().toArray(), {0.4832, 1.5089, -0.5188});
}
...
TEST(TEST_Optimizer, Adam) {
  ...
  optimizer.step();
  EXPECT_FLOAT_VEC_NEAR(x.data().toArray(), {0.4007, 1.5980, -0.5996});
  optimizer.step();
  EXPECT_FLOAT_VEC_NEAR(x.data().toArray(), {0.3012, 1.6959, -0.6993});
}
...
TEST(TEST_Optimizer, AdamW) {
  ...
  optimizer.step();
  EXPECT_FLOAT_VEC_NEAR(x.data().toArray(), {0.3960, 1.5845, -0.5947});
  optimizer.step();
  EXPECT_FLOAT_VEC_NEAR(x.data().toArray(), {0.2930, 1.6682, -0.6884});
}

...
TEST(TEST_Module, rope) {
  ...
  EXPECT_THAT(rope.cache().shape(), ElementsAre(3, 4, 2));
  EXPECT_TRUE(
      VectorNear(rope.cache().toList<float>(),
                 {1.0000, 0.0000, 1.0000, 0.0000, 1.0000,  0.0000, 1.0000, 0.0000, 0.5403,  0.8415, 0.9995, 0.0316,
                  0.5403, 0.8415, 0.9995, 0.0316, -0.4161, 0.9093, 0.9980, 0.0632, -0.4161, 0.9093, 0.9980, 0.0632}));

  RopeScalingConfig scaling{2.f, 4.f, 1.f, 2};
  rope = nn::RoPE(4, 3, 10000.f, scaling);
  EXPECT_TRUE(
      VectorNear(rope.cache().toList<float>(),
                 {1.0000, 0.0000, 1.0000, 0.0000, 1.0000, 0.0000, 1.0000, 0.0000, 0.8776, 0.4794, 1.0000, 0.0050,
                  0.8776, 0.4794, 1.0000, 0.0050, 0.5403, 0.8415, 0.9999, 0.0100, 0.5403, 0.8415, 0.9999, 0.0100}));
